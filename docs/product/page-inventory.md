...
| --- | --- | --- | --- | --- |
| `/` | Scaffolded | Catalog entry, featured products, release proof | typed mock | choose visual direction |
| `/catalog` | Scaffolded | Product list and first filter strip | typed mock | table vs card density |
| `/catalog/:productId` | Scaffolded | Product detail, specs, source evidence | typed mock | detail layout depth |
